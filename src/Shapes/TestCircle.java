...
public class TestCircle {
    ...
    public static void main(String[] args){
        ...
        System.out.println("c1 circle has radius of " + c1.getRadius() + " and area of " + c1.getArea());
        ...
        System.out.println("c2 circle has radius of " + c2.getRadius() + " and area of " + c2.getArea());
        //The circle has radius of 2.0 and area of 12.566370614359172


        Circle c3 = new Circle(3.0, "orange", true);
        System.out.println("c3 circle has radius of " + c3.getRadius() + " and area of " + c3.getArea() +
                " it also has a " + c3.getColor() + " color.");
        ...
        System.out.println("c5: " + c5.toString());   // explicit call
        ...
        Circle c7 = new Circle(2.2);
        System.out.println(c7);   // toString()
        // Test getArea() and getCircumference()
        System.out.printf("c7 area is: %.2f%n", c7.getArea());
        System.out.printf("c7 circumference is: %.2f%n", c7.getPerimeter());
    }
}
